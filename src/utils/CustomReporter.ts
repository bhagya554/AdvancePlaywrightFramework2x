 ...
 * @website Enhance Testing Skills
 * @version 1.0.0
...
class CustomTTAReporter implements Reporter {
    ...
    onTestBegin(test: TestCase): void {
        ...
        while (parent) {
            if (parent.title && parent.type === 'describe') {
    ...
    onTestEnd(test: TestCase, result: TestResult): void {
        ...
        let parent: Suite | undefined = test.parent;
        while (parent) {
            // Skip root/project/file suites - only real describe() blocks
            if (parent.title && parent.type === 'describe') {
                describePath.unshift(parent.title);
            }
            parent = parent.parent;
...
<title>Report - Latest</title></head>
